...
//                     <textarea id='content' ref = {this.postContentRef} name='content' className='form-control' placeholder='Product content' onChange={this.handleInputChange} required='required'/>
